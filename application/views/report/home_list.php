...
<div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
                    <table id="list-data-list" class="table table-bordered table-striped">
                              <thead>
                                        <tr>
                                                  ...
                                                  <th style="background-color: darkcyan; color: white;">Upgrade OS </th>
                                                  <th style="background-color: darkcyan; color: white;">Lan 1 GB </th>
                                                  <th style="background-color: darkcyan; color: white;">Edc Bca </th>
                                                  <th style="background-color: darkcyan; color: white;">Edc Mandiri
                                                  </th>
                                                  <th style="background-color: darkcyan; color: white;">Idm Listener
                                                  </th>
                                                  <th style="background-color: darkcyan; color: white;">Cpu Usage > 80
                                                  </th>
                                                  <th style="background-color: darkcyan; color: white;">Suhu Cpu > 80
                                                  </th>
                                                  <th style="background-color: darkcyan; color: white;">Boot Time > 4
                                                            Mnt
                                                  </th>
                                                  <th style="background-color: darkcyan; color: white;">Key Windows
                                                  </th>
