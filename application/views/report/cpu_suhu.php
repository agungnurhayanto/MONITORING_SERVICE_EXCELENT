...
<div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
                    <table id="list-data-cpu-suhu" class="table table-bordered table-striped">
                              <thead>
                                        <tr>
                                                  ...
                                                  <th style="background-color: darkcyan; color: white;">Suhu Cpu </th>
