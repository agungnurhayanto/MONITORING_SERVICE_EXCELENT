...
$users = [
  ...
  [
    ...
    'bg_color' => 'bg-yellow',
    'total_lan' => $total_rows['ILHAM MUHAMMAD FIRDAUS'],
    'total_cpu' => $total_rows_usage['ILHAM MUHAMMAD FIRDAUS'],
    'total_suhu' => $total_rows_suhu['ILHAM MUHAMMAD FIRDAUS'],
    'total_time' => $total_rows_boottime['ILHAM MUHAMMAD FIRDAUS'],
    'idm_listener' => $total_rows_idm_listener['ILHAM MUHAMMAD FIRDAUS'],
    'edc_bca' => $total_rows_edc_bca['ILHAM MUHAMMAD FIRDAUS'],
    'edc_bca_no_edc' => $total_rows_edc_bca_no_edc['ILHAM MUHAMMAD FIRDAUS'],
    'edc_mandiri' => $total_rows_edc_mandiri['ILHAM MUHAMMAD FIRDAUS'],
    'edc_mandiri_no_edc' => $total_rows_edc_mandiri_no_edc['ILHAM MUHAMMAD FIRDAUS'],
    'key_windows' => $total_rows_key_windows['ILHAM MUHAMMAD FIRDAUS'],
    'aktivasi_os' => $total_rows_aktivasi_os['ILHAM MUHAMMAD FIRDAUS']
  ],
  [
    'name' => 'Ega Ramadhani',
...
.progress-bar {
          height: 100px;
          /* Perbesar tinggi progress bar */
          font-size: 18px;
          /* Perbesar ukuran teks di dalam progress bar */
          line-height: 20px;
          /* Selaraskan teks secara vertikal */
          font-weight: bold;
          /* Buat teks lebih tebal */
          padding: 0 10px;
          /* Tambahkan padding di kanan dan kiri untuk ruang teks */
}
...
.progress {
          ...
          border-radius: 15px;
          /* Membuat sudut yang lebih membulat */
}
...
<div class="col-md-12">
      ...
      ?>
                                        ...
                                        <div class="col-md-6">
                                                  <div class="progress">
                                                            <div class="progress-bar progress-bar-aqua"
                                                                      role="progressbar"
                                                                      aria-valuenow="<?= $data_lan_terpakai; ?>"
                                                                      aria-valuemin="0"
                                                                      aria-valuemax="<?= $ttl_toko; ?>"
                                                                      style="width: <?= $persentase_lan_terpakai; ?>%">
                                                                      <span><?= $data_lan_terpakai; ?> Station sudah
                                                                                menggunakan LAN 1GB dari
                                                                                <?= $ttl_toko; ?> total toko
                                                                                (<?= round($persentase_lan_terpakai, 2); ?>%)</span>
                                                            </div>
                                                  </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                                  <div class="progress">
                                                            <div class="progress-bar progress-bar-green"
                                                                      ...
                                                                      aria-valuemin="0"
                                                                      aria-valuemax="<?= $ttl_toko; ?>"
                                                                      style="width: <?= $persentase_total_usage_ok; ?>%">
                                                                      <span><?= $data_cpu_usage; ?> Cpu Usage nya sudah
                                                                                OK dari <?= $ttl_toko; ?> total toko
                                                                                (<?= round($persentase_total_usage_ok, 2); ?>%)</span>
                                                            </div>
                                                  </div>
                                        </div>
                              </div>
                              ...
                              <div class="row">
                                        ...
                                        <div class="col-md-6">
                                                  <div class="progress">
                                                            <div class="progress-bar progress-bar-yellow"
                                                                      ...
                                                                      aria-valuemin="0"
                                                                      aria-valuemax="<?= $ttl_toko; ?>"
                                                                      style="width: <?= $persentase_total_suhu_ok; ?>%">
                                                                      <span><?= $data_cpu_suhu; ?> Suhu Cpu sudah OK
                                                                                dari <?= $ttl_toko; ?> total toko
                                                                                (<?= round($persentase_total_suhu_ok, 2); ?>%)</span>
                                                            </div>
                                                  </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                                  <div class="progress">
                                                            <div class="progress-bar progress-bar-dark cyan"
                                                                      role="progressbar"
                                                                      aria-valuenow="<?= $data_lan_terpakai; ?>"
                                                                      aria-valuemin="0"
                                                                      aria-valuemax="<?= $ttl_toko; ?>"
                                                                      style="width: <?= $persentase_total_boot_time; ?>%">
                                                                      <span><?= $data_boot_time; ?> Boot Time windows
                                                                                Kurang Dari 4 Menit dari
                                                                                <?= $ttl_toko; ?> total toko
                                                                                (<?= round($persentase_total_boot_time, 2); ?>%)</span>
                                                            </div>
                                                  </div>
                                        </div>
                              </div>
                                        ...
                                        <div class="box box-widget widget-user-2">
                                                  ...
                                                  <div class="box-footer no-padding">
                                                            <ul class="nav nav-stacked">
                                                                      ...
                                                                      <li><a href="<?php echo base_url('Report/edc_bca') ?>"
                                                                                          class="small-box-footer"
                                                                      ...
                                                                      <li><a href="<?php echo base_url('Report/idm_listener') ?>"
                                                                                          class="small-box-footer"
                                                                                          style="font-size: 20px;">Idm
                                                                                          Listener <i
                                                                                                    class="fa fa-arrow-circle-right"
                                                                                                    style="font-size: 20px;"></i>
                                                                                          <span class="pull-right badge bg-yellow"
                                                                                                    style="font-size: 20px;"><?php echo $user['idm_listener']; ?></span></a>
                                                                      </li>
                                                                      ...
                                                                      <li>
                                                                                <a href="<?php echo base_url('Report/cpu_usage') ?>"
                                                                                          class="small-box-footer"
                                                                                          style="font-size: 20px;">CPU
                                                                                          Usage >=80%
                                                                                          <i
                                                                                                    class="fa fa-arrow-circle-right"></i>
                                                                                          <span class="pull-right badge bg-aqua"
                                                                                                    style="font-size: 20px;"><?php echo $user['total_cpu']; ?></span>
                                                                                </a>
                                                                      </li>

                                                                      <li><a href="<?php echo base_url('Report/cpu_suhu') ?>"
                                                                                          class="small-box-footer"
                                                                                          style="font-size: 20px;">Suhu
                                                                                          cpu >=80 <i
                                                                                                    class="fa fa-arrow-circle-right"></i>

                                                                                          <span class="pull-right badge bg-green"
                                                                                                    style="font-size: 20px;"><?php echo $user['total_suhu']; ?></span></a>
                                                                      </li>


                                                                      <li><a href="<?php echo base_url('Report/cpu_boot') ?>"
                                                                                          class="small-box-footer"
                                                                                          style="font-size: 20px;">Boot
                                                                                          Time <4 menit <i
                                                                                                    class="fa fa-arrow-circle-right">
                                                                                                    </i>

                                                                                                    <span class="pull-right badge dark cyan"
                                                                                                              style="font-size: 20px;"><?php echo $user['total_time']; ?></span></a>
                                                                      </li>


                                                                      <li><a href="<?php echo base_url('Report/key_windows') ?>"
                                                                                          class="small-box-footer"
                                                                                          style="font-size: 20px;">Windows
                                                                                          Key <i class="fa fa-arrow-circle-right"
                                                                                                    style="font-size: 20px;"></i>
                                                                                          <span class="pull-right badge bg-blue"
                                                                                                    style="font-size: 20px;"><?php echo $user['key_windows']; ?></span></a>
                                                                      </li>

                                                                      <li><a href="<?php echo base_url('Report/aktivasi_os') ?>"
                                                                                          class="small-box-footer"
                                                                                          style="font-size: 20px;">Aktivasi
                                                                                          Windows <i class="fa fa-arrow-circle-right"
                                                                                                    style="font-size: 20px;"></i>
                                                                                          <span class="pull-right badge bg-aqua"
                                                                                                    style="font-size: 20px;"><?php echo $user['aktivasi_os']; ?></span></a>
                                                                      </li>
