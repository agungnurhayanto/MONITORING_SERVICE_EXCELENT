  ...
  <div class="box box-solid">
    ...
    <div class="box-body">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="progress">
            <div class="progress-bar progress-bar-dark cyan" role="progressbar" aria-valuenow="<?= $data_lan_terpakai; ?>" aria-valuemin="0" aria-valuemax="<?= $ttl_toko; ?>" style="width: <?= $persentase_total_boot_time; ?>%">
            ...
            <div class="box box-widget widget-user-2">
                ...
                <div class="box-footer no-padding">
                    <ul class="nav nav-stacked">
                        <li>
                            <a href="<?php echo base_url('Report') ?>" class="small-box-footer" style="font-size: 20px;">Lan 1 GB
                        ...
                        <li><a href="<?php echo base_url('Report/cpu_suhu') ?>" class="small-box-footer" style="font-size: 20px;">Suhu cpu >=80 <i class="fa fa-arrow-circle-right"></i>

                         <span class="pull-right badge bg-green" style="font-size: 20px;"><?php echo $user['total_suhu']; ?></span></a></li>


                           <li><a href="<?php echo base_url('Report/cpu_boot') ?>" class="small-box-footer" style="font-size: 20px;">Boot Time <4 menit <i class="fa fa-arrow-circle-right"></i>
                            ...
                            <li><a href="<?php echo base_url('Report/aktivasi_os') ?>" class="small-box-footer" style="font-size: 20px;">Aktivasi Windows <i class="fa fa-arrow-circle-right" style="font-size: 20px;"></i>
                            <span class="pull-right badge bg-aqua" style="font-size: 20px;"><?php echo $user['aktivasi_os']; ?></span></a></li>
