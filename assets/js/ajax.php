<script type="text/javascript">
  ...
  var MyTable16 = $('#list-data-report').dataTable({
    "paging": true,
    "lengthChange": true,
    "searching": true,
    "ordering": true,
  ...
  var MyTable17 = $('#list-data-ups-nok').dataTable({
    "paging": true,
    "lengthChange": true,
    "searching": true,
    "ordering": true,
  ...
  function refresh16() {
    MyTable16 = $('#list-data-report').dataTable();
  }

  function refresh17() {
    MyTable17 = $('#list-data-ups-nok').dataTable();
  }
  ...
  function tampilReport16() {
    $.ajax({
      url: '<?php echo base_url('Report/tampil_hasil'); ?>',
      type: 'GET',
      cache: true,
      success: function(data) {
        MyTable16.fnDestroy();
        $('#data-report-report').html(data);
        refresh16();
      }
    });
  }

  function tampilReport17() {
    $.ajax({
      url: '<?php echo base_url('Report/tampil_ups_nok'); ?>',
      type: 'GET',
      cache: true,
      success: function(data) {
        MyTable17.fnDestroy();
        $('#data-report-ups-nok').html(data);
        refresh17();
      }
    });
  }
